...
{
    public partial class UC_Eventi: MetroFramework.Forms.MetroForm
    {
        ...
        private void UC_Eventi_Load(object sender, EventArgs e)
        {
            // TODO: questa riga di codice carica i dati nella tabella 'ds_Eventi.UI_Events'. È possibile spostarla o rimuoverla se necessario.
            this.uI_EventsTableAdapter1.Fill(this.ds_Eventi.UI_Events);
            // TODO: questa riga di codice carica i dati nella tabella 'ds_Eventi.UI_Events_Anag'. È possibile spostarla o rimuoverla se necessario.
            this.uI_Events_AnagTableAdapter.Fill(this.ds_Eventi.UI_Events_Anag);
            SettaForm();
        ...
        private void UC_Eventi_Shown(object sender, EventArgs e)
        {
            tbx_ReadLabel_Device.Focus();
        }
