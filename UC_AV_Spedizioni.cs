...
{
    public partial class UC_AV_Spedizioni : MetroFramework.Forms.MetroForm
    {
        public UC_AV_Spedizioni()
        {
            InitializeComponent();
        }

        private void UC_AV_Spedizioni_Load(object sender, EventArgs e)
        {
