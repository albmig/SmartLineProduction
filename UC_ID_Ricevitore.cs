...
{
    public partial class UC_ID_Ricevitore : MetroFramework.Forms.MetroForm
    {
        ...
        public UC_ID_Ricevitore()
        {
            InitializeComponent();
        }

        private void UC_ID_Ricevitore_Load(object sender, EventArgs e)
        {
            cb_famiglia.Text = "SmartBox 8 SL";
            Calcola_ID();
        }
        ...
        private void Calcola_ID()
        {
            ...
            // Aggiungo Famiglia
            if (cb_famiglia.SelectedIndex == 0) { fam_hex = '3'; } //Easy SL
            if (cb_famiglia.SelectedIndex == 1) { fam_hex = '4'; } //Trend SL
            if (cb_famiglia.SelectedIndex == 2) { fam_hex = '6'; } //Easy Lift SL
        ...
        private void but_close_UC_ID_Ricevitore_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
