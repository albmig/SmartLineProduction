...
{
    public partial class UC_Prototipo_ID_Ricevitore : MetroFramework.Forms.MetroForm
    {
        ...
        public UC_Prototipo_ID_Ricevitore(string PassedDevice)
        {
            InitializeComponent();
            this.CodiceDevice = PassedDevice;
        }

        private void UC_Prototipo_ID_Ricevitore_Load(object sender, EventArgs e)
        {
        ...
        private void but_close_UC_Prototipo_ID_Ricevitore_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        ...
        private void FiltraFamProd()
        {
            ...
            foreach (DataRowView famprodRow in famProdBindingSource)
            {
                ...
                if ((CodiceDevice.Substring(0, len_alias) == famprodRow["Fam_Alias_Progettazione"].ToString()) || (CodiceDevice.Substring(0, len_dev) == famprodRow["Fam_Prefix"].ToString()))
                {
                    ...
                    //Definisci Radius
                    if (fam_hex == '9') { IsRadius = true; } else { IsRadius = false; }
        ...
        private void but_24_CheckedChanged_1(object sender, EventArgs e)
        {
            Calcola_ID();
        }
    }
